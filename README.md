...
- Known Bug: pause button works, but when timer is running and paused is clicked, the time range doesn't update and will show an incorrect end time when the timer ends.
- Known Bug: light mode might not work if browser/system default is set to dark mode.
